...
namespace SandboxService.Persistence.Migrations
{
    ...
    [Migration("20241224184702_PositionExitPrice")]
    partial class PositionExitPrice
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SandboxService.Core.Models.MarginPosition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("MarginPositions");
                });

            modelBuilder.Entity("SandboxService.Core.Models.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SandboxService.Core.Models.MarginPosition", b =>
                {
                    ...
                    b.HasOne("SandboxService.Core.Models.User", "User")
                        .WithMany("MarginPositions")
            ...
            modelBuilder.Entity("SandboxService.Core.Models.Order", b =>
                {
                    b.HasOne("SandboxService.Core.Models.MarginPosition", "Position")
                        .WithMany()
                        .HasForeignKey("PositionId");

                    b.HasOne("SandboxService.Core.Models.User", null)
                        .WithMany("Orders")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
